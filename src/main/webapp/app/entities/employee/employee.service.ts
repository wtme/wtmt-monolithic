...
export class EmployeeService {
  ...
  protected convertDateFromClient(employee: IEmployee): IEmployee {
    const copy: IEmployee = Object.assign({}, employee, {
      dateOfJoining: employee.dateOfJoining != null && employee.dateOfJoining.isValid() ? employee.dateOfJoining.toJSON() : null,
      dateOfBirth: employee.dateOfBirth != null && employee.dateOfBirth.isValid() ? employee.dateOfBirth.toJSON() : null
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      res.body.dateOfJoining = res.body.dateOfJoining != null ? moment(res.body.dateOfJoining) : null;
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((employee: IEmployee) => {
        employee.dateOfJoining = employee.dateOfJoining != null ? moment(employee.dateOfJoining) : null;
