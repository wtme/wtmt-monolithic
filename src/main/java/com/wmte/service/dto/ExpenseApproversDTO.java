...
/**
 * A DTO for the {@link com.wmte.domain.ExpenseApprovers} entity.
 */
public class ExpenseApproversDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        ExpenseApproversDTO expenseApproversDTO = (ExpenseApproversDTO) o;
        if (expenseApproversDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), expenseApproversDTO.getId());
    }
