...
import { DepartmentRoleComponent } from 'app/entities/department-role/department-role.component';
...
describe('Component Tests', () => {
  describe('DepartmentRole Management Component', () => {
    let comp: DepartmentRoleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DepartmentRoleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.departmentRoles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
