...
import { EmployeeDepartmentComponent } from 'app/entities/employee-department/employee-department.component';
...
describe('Component Tests', () => {
  describe('EmployeeDepartment Management Component', () => {
    let comp: EmployeeDepartmentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EmployeeDepartmentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new EmployeeDepartment(123)],
            headers
          })
        )
      );
      ...
      expect(comp.employeeDepartments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
