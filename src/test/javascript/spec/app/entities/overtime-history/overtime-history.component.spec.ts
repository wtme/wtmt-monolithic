...
import { OvertimeHistoryComponent } from 'app/entities/overtime-history/overtime-history.component';
...
describe('Component Tests', () => {
  describe('OvertimeHistory Management Component', () => {
    let comp: OvertimeHistoryComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OvertimeHistoryComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.overtimeHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
