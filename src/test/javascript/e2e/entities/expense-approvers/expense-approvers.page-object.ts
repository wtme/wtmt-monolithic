...
export class ExpenseApproversComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-expense-approvers div table .btn-danger'));
  title = element.all(by.css('jhi-expense-approvers div h2#page-heading span')).first();
...
export class ExpenseApproversUpdatePage {
  pageTitle = element(by.id('jhi-expense-approvers-heading'));
...
export class ExpenseApproversDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-expenseApprovers-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-expenseApprovers'));
